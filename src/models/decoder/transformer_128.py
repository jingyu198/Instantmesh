...
class TriplaneTransformer(nn.Module):
    ...
    def __init__(
        ...
        # attributes
        self.triplane_low_res = triplane_low_res   # 32
        self.triplane_high_res = triplane_high_res   # 64
        self.triplane_dim = triplane_dim   # 80
        ...
        self.deconv = nn.ConvTranspose2d(inner_dim, triplane_dim, kernel_size=8, stride=8, padding=0)
        #self.deconv2 = nn.ConvTranspose2d(80, triplane_dim, kernel_size=2, stride=2, padding=0)
